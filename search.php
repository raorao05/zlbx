...
if ($_REQUEST['act'] == 'advanced_search')
{
	...
	$cat_arr=get_categories_tree();
	$i=1;
	foreach($cat_arr as $key=>$v){
		$categories_list[$i++]=$v;
	}
    $smarty->assign('categories',       $categories_list);  // 分类树
...
else
{
    ...
    $sql = "SELECT g.goods_id, g.goods_name, g.market_price, g.is_new, g.is_best, g.is_hot, g.shop_price AS org_price, ".
                ...
                "g.promote_price, g.promote_start_date, g.promote_end_date, g.goods_thumb, g.goods_img, g.goods_brief, g.goods_type, g.goods_sn, g.salesnum, g.list_desc ".
	...
	$smarty->assign('intro',$_REQUEST['intro']);
