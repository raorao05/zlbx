...
function get_profile($user_id)
{
	...
	$info['alias']      = isset($infos['alias']) ? $infos['alias'] : '';//姓名
	$info['zj_number']      = isset($infos['zj_number']) ? $infos['zj_number'] : '';//证件号
	$info['tuijian']      = $tuijian ? $tuijian : '';//推荐人
        ...
        $order['order_status'] == OS_CONFIRMED))
    {
        ...
        else
        {
            ...
            if($order['pay_name'] == '微信支付'){
                $order['pay_online'] = '<input type="button" onclick="window.location.href=\'./weixinpay.php?out_trade_no='.$order['log_id'].'\'" value="微信支付"/>';
            }else{
