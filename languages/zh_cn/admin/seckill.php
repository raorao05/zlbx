...
$_LANG['label_seckill_price'] = '秒杀价格：';
$_LANG['label_restrict_amount'] = '限购数量：';
$_LANG['notice_restrict_amount']= '达到此数量，秒杀活动自动结束。0表示没有数量限制。';
$_LANG['label_seckill_img'] = '秒杀图片：';
...
$_LANG['error_seckill'] = '您要操作的秒杀活动不存在';
...
$_LANG['cancel_order_reason'] = '秒杀失败';
$_LANG['js_languages']['succeed_confirm'] = '此操作不可逆，您确定要设置该秒杀活动成功吗？';
$_LANG['js_languages']['fail_confirm'] = '此操作不可逆，您确定要设置该秒杀活动失败吗？';
$_LANG['button_mail'] = '发送邮件';
$_LANG['notice_mail'] = '（通知客户付清余款，以便发货）';
$_LANG['mail_result'] = '该秒杀活动共有 %s 个有效订单，成功发送了 %s 封邮件。';
$_LANG['invalid_time'] = '您输入了一个无效的秒杀时间。';

$_LANG['add_success'] = '添加秒杀活动成功。';
$_LANG['edit_success'] = '编辑秒杀活动成功。';
$_LANG['back_list'] = '返回秒杀活动列表。';
$_LANG['continue_add'] = '继续添加秒杀活动。';

/* 添加/编辑活动提交 */
$_LANG['error_goods_null'] = '您没有选择秒杀商品！';
$_LANG['error_goods_exist'] = '您选择的商品目前有一个秒杀活动正在进行！';
$_LANG['error_seckill_img'] = '请选择秒杀商品图片！';
$_LANG['error_restrict_amount'] = '限购数量不能小于价格阶梯中的最大数量';

$_LANG['js_languages']['error_goods_null'] = '您没有选择秒杀商品！';
$_LANG['js_languages']['error_number'] = '您输入的限购数量不是数字！';
...
/* 删除秒杀活动 */
$_LANG['js_languages']['batch_drop_confirm'] = '您确定要删除选定的秒杀活动吗？';
$_LANG['error_exist_order'] = '该秒杀活动已经有订单，不能删除！';
$_LANG['batch_drop_success'] = '成功删除了 %s 条秒杀活动记录（已经有订单的秒杀活动不能删除）。';
$_LANG['no_select_seckill'] = '您现在没有秒杀活动记录！';

/* 操作日志 */
$_LANG['log_action']['seckill'] = '秒杀商品';
