...
class imgupload{
    ...
    public $al_ph_type=array('application/vnd.openxmlformats-officedocument.spreadsheetml.sheet','application/vnd.ms-excel');//07版本    //允许上传图片类型//'application/vnd.ms-excel', 07之前的版本
    ...
    function check_type(){
        if(!in_array($this->ph_type,$this->al_ph_type)){
            echo $this->ph_type;
            $this->showerror("上传文件类型错误".$this->ph_type);
        }
    }
    //上传图片
    function up_photo(){
