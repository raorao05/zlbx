...
/*    $editor = new FCKeditor($input_name);
	...
	$kindeditor="<script charset=\"gb2312\" src=\"../kedit/kindeditor-min.js\"></script><script charset=\"utf-8\" src=\"../kedit/lang/zh_CN.js\"></script><script>var editor;KindEditor.ready(function(K) {editor = K.create('textarea[name=\"$input_name\"]',{filterMode: false});})</script><textarea id=\"$input_name\" name=\"$input_name\" style='width:700px;height:300px;'>$input_value</textarea>"; 
...
/*    $editor = new FCKeditor($input_name);
    ...
    $FCKeditor = $editor->CreateHtml();*/
     //$smarty->assign('FCKeditor', $FCKeditor);
	$kindeditor="<script charset=\"gb2312\" src=\"../kedit/kindeditor-min.js\"></script><script charset=\"utf-8\" src=\"../kedit/lang/zh_CN.js\"></script><script>var editor;KindEditor.ready(function(K) {editor = K.create('textarea[name=\"$input_name\"]',{filterMode: false});})</script><textarea id=\"$input_name\" name=\"$input_name\" style='width:700px;height:300px;'>$input_value</textarea>"; 
    $smarty->assign('FCKeditor1', $kindeditor); 
}
...
/*    $editor = new FCKeditor($input_name);
    ...
    $FCKeditor = $editor->CreateHtml();*/
     //$smarty->assign('FCKeditor', $FCKeditor);
	$kindeditor="<script charset=\"gb2312\" src=\"../kedit/kindeditor-min.js\"></script><script charset=\"utf-8\" src=\"../kedit/lang/zh_CN.js\"></script><script>var editor;KindEditor.ready(function(K) {editor = K.create('textarea[name=\"$input_name\"]',{filterMode: false});})</script><textarea id=\"$input_name\" name=\"$input_name\" style='width:700px;height:300px;'>$input_value</textarea>"; 
    $smarty->assign('FCKeditor2', $kindeditor); 
}
...
function create_html_editor3($input_name,  $input_value = '')
{
    ...
    $editor->Value      = $input_value;
    $FCKeditor = $editor->CreateHtml();*/
	$kindeditor="<script charset=\"gb2312\" src=\"../kedit/kindeditor-min.js\"></script><script charset=\"utf-8\" src=\"../kedit/lang/zh_CN.js\"></script><script>var editor1;KindEditor.ready(function(K) {editor1 = K.create('textarea[name=\"$input_name\"]',{filterMode: false});})</script><textarea id=\"$input_name\" name=\"$input_name\" style='width:700px;height:300px;'>$input_value</textarea>"; 
    $smarty->assign('FCKeditor4', $kindeditor);//这里输出就用$output_name变量了。
}
...
function create_html_editor4($input_name,  $input_value = '')
{
    ...
    $editor->Value      = $input_value;
    $FCKeditor = $editor->CreateHtml();*/
	$kindeditor="<script charset=\"gb2312\" src=\"../kedit/kindeditor-min.js\"></script><script charset=\"utf-8\" src=\"../kedit/lang/zh_CN.js\"></script><script>var editor2;KindEditor.ready(function(K) {editor2 = K.create('textarea[name=\"$input_name\"]',{filterMode: false});})</script><textarea id=\"$input_name\" name=\"$input_name\" style='width:700px;height:300px;'>$input_value</textarea>"; 
    $smarty->assign('FCKeditor5', $kindeditor);//这里输出就用$output_name变量了。
}
