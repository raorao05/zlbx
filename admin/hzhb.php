...
{
    /* 模板赋值 */
    $smarty->assign('ur_here',    '合作伙伴');
    $smarty->assign('action_link', array('text' =>'添加合作伙伴', 'href' => 'hzhb.php?act=add'));
...
elseif ($_REQUEST['act'] == 'add')
{
    ...
    $smarty->assign('ur_here',     '添加合作伙伴');
    $smarty->assign('action_link', array('href'=>'hzhb.php?act=list', 'text' => '合作伙伴'));
...
elseif ($_REQUEST['act'] == 'edit')
{
    ...
    /* 模板赋值 */
    $smarty->assign('ur_here',     '编辑合作伙伴');
    $smarty->assign('action_link', array('href'=>'hzhb.php?act=list&' . list_link_postfix(), 'text' =>'合作伙伴'));
