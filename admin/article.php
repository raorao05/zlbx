...
if ($_REQUEST['act'] == 'add')
{
	...
	create_html_editor1('FCKeditor2');
	create_html_editor2('FCKeditor3');
...
if ($_REQUEST['act'] == 'insert')
{
    ...
    $sql = "INSERT INTO ".$ecs->table('article')."(title, cat_id, article_type, is_open, author, ".
                "author_email, keywords, content, add_time, file_url, open_type, link, description,lipei,hzbx,province,city,district,tel,address,fwxm, ".
				"basj, pfsj, xz, ajlx, bdh, cbgs, bxcp, pfje) ".
            "VALUES ('$_POST[title]', '$_POST[article_cat]', '$_POST[article_type]', '$_POST[is_open]', ".
                ...
                "'$add_time', '$file_url', '$open_type', '$_POST[link_url]', '$_POST[description]','$_POST[FCKeditor2]','$_POST[FCKeditor3]','$_POST[province]','$_POST[city]','$_POST[district]','$_POST[tel]',".
				"'$_POST[address]','$_POST[fwxm]','$_POST[basj]','$_POST[pfsj]','$_POST[xz]','$_POST[ajlx]','$_POST[bdh]','$_POST[cbgs]','$_POST[bxcp]','$_POST[pfje]')";
    $db->query($sql);
...
if ($_REQUEST['act'] == 'edit')
{
	...
	create_html_editor1('FCKeditor2',$article['lipei']);
	create_html_editor2('FCKeditor3',$article['hzbx']);
    ...
    $smarty->assign('city_list',        get_regions(2,$article['province']));
    $smarty->assign('district_list',    get_regions(3,$article['city']));
...
if ($_REQUEST['act'] =='update')
{
    ...
    if ($exc->edit("title='$_POST[title]', cat_id='$_POST[article_cat]', article_type='$_POST[article_type]', is_open='$_POST[is_open]', author='$_POST[author]', author_email='$_POST[author_email]', keywords ='$_POST[keywords]', file_url ='$file_url', open_type='$open_type', content='$_POST[FCKeditor1]', link='$_POST[link_url]', description = '$_POST[description]', lipei='$_POST[FCKeditor2]', hzbx='$_POST[FCKeditor3]', province='$_POST[province]', city='$_POST[city]', district='$_POST[district]', tel='$_POST[tel]', address='$_POST[address]', fwxm='$_POST[fwxm]', basj='$_POST[basj]', pfsj='$_POST[pfsj]', xz='$_POST[xz]', ajlx='$_POST[ajlx]', bdh='$_POST[bdh]', cbgs='$_POST[cbgs]', bxcp='$_POST[bxcp]', pfje='$_POST[pfje]'", $_POST['id']))
    {
