...
<?php else: ?>
 ...
 <div id="pager" class="pagebar">
  ...
  <?php if ($this->_var['pager']['page_prev']): ?><a class="w_paeg1" href="<?php echo $this->_var['pager']['page_prev']; ?>"><i></i><?php echo $this->_var['lang']['page_prev']; ?></a><?php endif; ?>
...
?>
      ...
      <a href="javascript:;" class="w_paeg_dq"><?php echo $this->_var['key']; ?></a>
      <?php else: ?>
  ...
  <?php if ($this->_var['pager']['page_next']): ?><a class="w_paeg2" href="<?php echo $this->_var['pager']['page_next']; ?>"><i></i><?php echo $this->_var['lang']['page_next']; ?></a><?php endif; ?>
