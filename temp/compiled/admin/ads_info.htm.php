...
<form action="ads.php" method="post" name="theForm" enctype="multipart/form-data" onsubmit="return validate()">
  ...
  <?php if ($this->_var['ads']['media_type'] == 0 || $this->_var['action'] == "add"): ?>
    ...
    <tr>
      ...
      <td rowspan="2" align="left" width="120" height="80" style="overflow:hidden"><img src="<?php echo $this->_var['img_src']; ?>" width="100" /></td>
    </tr>
    <tr>
      <td  class="label"><?php echo $this->_var['lang']['img_url']; ?></td>
      <td valign="top"><input type="text" name="img_url" value="<?php echo $this->_var['img_src']; ?>" size="35" /></td>
    </tr>
    </tbody>
  <?php endif; ?>
  ...
  <?php if ($this->_var['ads']['media_type'] == 2 || $this->_var['action'] == "add"): ?>
    <tbody id="2" style="<?php if ($this->_var['ads']['media_type'] != 2 || $this->_var['action'] == 'add'): ?>display:none<?php endif; ?>">
      <tr>
        ...
        <td colspan="2"><textarea name="ad_code" cols="50" rows="7"><?php echo $this->_var['ads']['ad_code']; ?></textarea></td>
      </tr>
    </tbody>
  <?php endif; ?>
  ...
  <?php if ($this->_var['ads']['media_type'] == 3 || $this->_var['action'] == "add"): ?>
    ...
    <tr>
      ...
      <td colspan="2"><textarea name="ad_text" cols="40" rows="3"><?php echo $this->_var['ads']['ad_code']; ?></textarea></td>
    </tr>
    </tbody>
 <?php endif; ?>
