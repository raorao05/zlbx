...
<div class="tab-div">
    ...
    <div id="tabbar-div">
      <p>
        ...
        <span class="tab-back" id="jd-tab"><?php echo $this->_var['lang']['tab_jd']; ?></span>
        <span
        ...
        <span class="tab-back" id="tbxz-tab">投保险种</span>
...
?>
        ...
        <table width="90%" id="detail-table" style="display:none">
          <tr>
            <td><?php echo $this->_var['lang']['tab_detail']; ?><?php echo $this->_var['FCKeditor']; ?></td>
          </tr>
          <tr>
            <td><?php echo $this->_var['lang']['tab_detail_list']; ?><?php echo $this->_var['FCKeditor4']; ?></td>
          </tr>
        </table>
        
        <table width="90%" id="jd-table" style="display:none">
          <tr>
            <td><?php echo $this->_var['FCKeditor5']; ?></td>
          </tr>
        </table>
...
<!--            <td><input type="text" name="goods_number" value="<?php echo $this->_var['goods']['goods_number']; ?>" size="20" <?php if ($this->_var['code'] != '' || $this->_var['goods']['_attribute'] != ''): ?>readonly="readonly"<?php endif; ?> /><br />-->
          ...
          <tr>
            <td class="label"><?php echo $this->_var['lang']['lab_goods_syrq']; ?></td>
            <td><input type="text" name="goods_syrq" value="<?php echo htmlspecialchars($this->_var['goods']['goods_syrq']); ?>" size="40" /></td>
          </tr>
          <tr>
              <td class="label">承保年龄：</td>
              <td><input type="text" name="goods_cbnl" value="<?php echo htmlspecialchars($this->_var['goods']['goods_cbnl']); ?>" size="40" /></td>
          </tr>
          <tr>
              <td class="label">保单形式：</td>
              <td><input type="text" name="goods_bdxs" value="<?php echo htmlspecialchars($this->_var['goods']['goods_bdxs']); ?>" size="40" /></td>
          </tr>
          <tr>
              <td class="label">限购份数：</td>
              <td><input type="text" name="goods_xgfs" value="<?php echo htmlspecialchars($this->_var['goods']['goods_xgfs']); ?>" size="40" /></td>
          </tr>
          <tr>
            <td class="label"><?php echo $this->_var['lang']['lab_goods_tbxz']; ?> </td>
            <td><textarea name="goods_tbxz" cols="70" rows="7"><?php echo htmlspecialchars($this->_var['goods']['goods_tbxz']); ?></textarea></td>
          </tr>
          <tr>
            <td class="label"><?php echo $this->_var['lang']['lab_goods_alfx']; ?> </td>
            <td><textarea name="goods_alfx" cols="70" rows="7"><?php echo htmlspecialchars($this->_var['goods']['goods_alfx']); ?></textarea></td>
          </tr>
        </table>
...
?>
        ...
        <!-- 投保险种 -->
        <table width="90%" id="tbxz-table" style="display:none">
          <tr>
          <td>
          <table width="100%" id="testTbl" >
          <tr><td class="label">车险类型：</td>
            <td>
              <span style="margin-right:20px;">单交强：<input type="radio" name="cx_type" value="1" checked="checked" /></span>
              <span style="margin-right:20px;">大众版：<input type="radio" name="cx_type" value="2" /></span>
              <span>加强版：<input type="radio" name="cx_type" value="3" /></span>
            </td>
          </tr>
          <?php if ($this->_var['tbxz']): ?>
...
?> -->
          <tr>
              ...
              <td class="label">添加险种<a href="javascript:;" onclick="addRow();">[+]</a></td>
              <?php else: ?>
              <td class="label">减少<a href="javascript:;" onclick="removeRow(this);">[-]</a></td>
              <?php endif; ?>
              <td>险种名称：<input type="text" name="xz_name[]" value="<?php echo $this->_var['r']['xz_name']; ?>" /></td>
              <td>投保金额：<input type="text" name="tb_price[]" value="<?php echo $this->_var['r']['tb_price']; ?>" /></td>
              <td>不计免赔：<input type="checkbox" name="is_mp[]" value="1" <?php if ($this->_var['r']['is_mp'] == 1): ?>checked="checked"<?php endif; ?> /></td>
              <td>保费：<input type="text" name="price[]" value="<?php echo $this->_var['r']['price']; ?>" /></td>
          </tr>
          <!-- <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?> -->
          <?php else: ?>
          <tr>
              <td class="label">添加险种<a href="javascript:;" onclick="addRow();">[+]</a></td>
              <td>险种名称：<input type="text" name="xz_name[]" /></td>
              <td>投保金额：<input type="text" name="tb_price[]" /></td>
              <td>不计免赔：<input type="checkbox" name="is_mp[]" value="1" /></td>
              <td>保费：<input type="text" name="price[]" /></td>
          </tr>
          <?php endif; ?>
          </table>
          </td>
        ...
        <div class="button-div">
          ...
          <?php endif; ?>
          <input type="button" value="<?php echo $this->_var['lang']['button_submit']; ?>" class="button" onclick="document.getElementById('goods_desc').value=editor.html();validate('<?php echo $this->_var['goods']['goods_id']; ?>')" />
...
//设置列内容和属性
newTd0.innerHTML = '<td>减少<a href="javascript:;" onclick="removeRow(this);">[-]</a></td>';
newTd0.setAttribute("class","label"); 
newTd1.innerHTML= '<td>险种名称：<input type="text" name="xz_name[]" /></td>';
newTd2.innerHTML= '<td>投保金额：<input type="text" name="tb_price[]" /></td>';
newTd3.innerHTML= '<td>不计免赔：<input type="checkbox" name="is_mp[]" value="1" /></td>';
newTd4.innerHTML= '<td>保费：<input type="text" name="price[]" /></td>';
...
?>
  ...
  {
	  document.getElementById('list_desc').value=editor1.html();
	  document.getElementById('goods_jd').value=editor2.html();
