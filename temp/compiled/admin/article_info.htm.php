...
<div class="tab-div">
  <div id="tabbar-div">
    <p>
      ...
      <span class="tab-back" id="wd-tab">网点服务</span>
      <span class="tab-back" id="lp-tab">理赔案例</span>
    </p>
  </div>
  ...
  <div id="tabbody-div">
    ...
    <table width="90%" id="detail-table" style="display:none">
     ...
     <tr><td><textarea id="FCKeditor1" name="FCKeditor1" style="width:100%;height:500px;"> <?php echo $this->_var['article']['content']; ?></textarea>
       </td></tr>
...
?>
    ...
    <div id="wd-tab">
        <table width="90%" id="wd-table" style="display:none">
         <tr>
            <td width="10%">地区：</td>
            <td colspan="3"><select name="country" id="selCountries" onchange="region.changed(this, 1, 'selProvinces')" style="display:none">
...
?> -->
                  <option value="<?php echo $this->_var['province']['region_id']; ?>" <?php if ($this->_var['article']['province'] == $this->_var['province']['region_id']): ?>selected<?php endif; ?>><?php echo $this->_var['province']['region_name']; ?></option>
          <!-- <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?> -->
        </select>
    ...
    foreach ($_from AS $this->_var['province']):
?> -->
                  <option value="<?php echo $this->_var['province']['region_id']; ?>" <?php if ($this->_var['article']['city'] == $this->_var['province']['region_id']): ?>selected<?php endif; ?>><?php echo $this->_var['province']['region_name']; ?></option>
          <!-- <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?> -->
        </select>
    ...
    foreach ($_from AS $this->_var['province']):
?> -->
                  <option value="<?php echo $this->_var['province']['region_id']; ?>" <?php if ($this->_var['article']['district'] == $this->_var['province']['region_id']): ?>selected<?php endif; ?>><?php echo $this->_var['province']['region_name']; ?></option>
          <!-- <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?> -->
        </select></td>
         </tr>
         <tr>
            <td>联系电话：</td>
            <td><input type="text" name="tel" size ="40" maxlength="60" value="<?php echo $this->_var['article']['tel']; ?>" /></td>
         </tr>
         <tr>
            <td>详细地址：</td>
            <td><input type="text" name="address" size ="40" maxlength="60" value="<?php echo $this->_var['article']['address']; ?>" /></td>
         </tr>
         <tr>
            <td>服务项目：</td>
            <td><input type="text" name="fwxm" size ="40" maxlength="60" value="<?php echo $this->_var['article']['fwxm']; ?>" /></td>
         </tr>
        </table>
    </div>
    <div id="lp-tab">
        <table width="90%" id="lp-table" style="display:none">
         <tr>
            <td width="10%">报案时间：</td>
            <td><input type="text" name="basj" size ="40" maxlength="60" value="<?php echo $this->_var['article']['basj']; ?>" /></td>
         </tr>
         <tr>
            <td>赔付时间：</td>
            <td><input type="text" name="pfsj" size ="40" maxlength="60" value="<?php echo $this->_var['article']['pfsj']; ?>" /></td>
         </tr>
         <tr>
            <td>险 种：</td>
            <td><input type="text" name="xz" size ="40" maxlength="60" value="<?php echo $this->_var['article']['xz']; ?>" /></td>
         </tr>
         <tr>
            <td>案件类型：</td>
            <td><input type="text" name="ajlx" size ="40" maxlength="60" value="<?php echo $this->_var['article']['ajlx']; ?>" /></td>
         </tr>
         <tr>
            <td>保单号：</td>
            <td><input type="text" name="bdh" size ="40" maxlength="60" value="<?php echo $this->_var['article']['bdh']; ?>" /></td>
         </tr>
         <tr>
            <td>承保公司：</td>
            <td><input type="text" name="cbgs" size ="40" maxlength="60" value="<?php echo $this->_var['article']['cbgs']; ?>" /></td>
         </tr>
         <tr>
            <td>保险产品：</td>
            <td><input type="text" name="bxcp" size ="40" maxlength="60" value="<?php echo htmlspecialchars($this->_var['article']['bxcp']); ?>" /></td>
         </tr>
         <tr>
            <td>赔付金额：</td>
            <td><input type="text" name="pfje" size ="40" maxlength="60" value="<?php echo $this->_var['article']['pfje']; ?>" /></td>
         </tr>
        </table>
    </div>
...
if(!"<?php echo $this->_var['article']['province']; ?>"){
	$("#selCountries").change();
}
