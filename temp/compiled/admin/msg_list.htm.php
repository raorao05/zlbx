...
<div class="form-div">
  <form action="javascript:searchMsg()" name="searchForm">
    ...
    <select name="msg_type">
      ...
      <option value="6"><?php echo $this->_var['lang']['type']['6']; ?></option>
    </select>
...
?>
  <tr>
    ...
    <td align="left"><?php if ($this->_var['msg']['msg_status'] == 0): ?>未处理<?php elseif ($this->_var['msg']['msg_status'] == 1): ?>已处理<?php endif; ?></td>
