...
?>
        <li>
        <img src="<?php if ($this->_var['comment']['avatar']): ?><?php echo $this->_var['comment']['avatar']; ?><?php else: ?>/images/change_avtar.png<?php endif; ?>" title="<?php echo htmlspecialchars($this->_var['comment']['username']); ?>" alt="<?php echo htmlspecialchars($this->_var['comment']['username']); ?>"/>
        <h2><span><?php echo $this->_var['comment']['add_time']; ?></span><?php echo htmlspecialchars($this->_var['comment']['username']); ?></h2>
        <h3><span><img src="themes/default/images/stars<?php echo $this->_var['comment']['rank']; ?>.gif" alt="<?php echo $this->_var['comment']['comment_rank']; ?>" style="height:auto;" /></span><?php echo $this->_var['comment']['content']; ?></h3>
       ...
       <div id="pagebar" class="f_r">
        ...
        <div id="pager">
          <?php echo $this->_var['lang']['pager_1']; ?><?php echo $this->_var['pager']['record_count']; ?><?php echo $this->_var['lang']['pager_2']; ?><?php echo $this->_var['lang']['pager_3']; ?><?php echo $this->_var['pager']['page_count']; ?><?php echo $this->_var['lang']['pager_4']; ?> <span> <a href="<?php echo $this->_var['pager']['page_first']; ?>"><?php echo $this->_var['lang']['page_first']; ?></a> <a href="<?php echo $this->_var['pager']['page_prev']; ?>"><?php echo $this->_var['lang']['page_prev']; ?></a> <a href="<?php echo $this->_var['pager']['page_next']; ?>"><?php echo $this->_var['lang']['page_next']; ?></a> <a href="<?php echo $this->_var['pager']['page_last']; ?>"><?php echo $this->_var['lang']['page_last']; ?></a> </span>
            <?php $_from = $this->_var['pager']['search']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'item_0_35815200_1477446738');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['item_0_35815200_1477446738']):
?>
            <input type="hidden" name="<?php echo $this->_var['key']; ?>" value="<?php echo $this->_var['item_0_35815200_1477446738']; ?>" />
            <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
        </div>
        <?php else: ?>
         ...
         <div id="pager" class="pagebar">
          ...
          <?php $_from = $this->_var['pager']['page_number']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'item_0_35815200_1477446738');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['item_0_35815200_1477446738']):
?>
                <?php if ($this->_var['pager']['page'] == $this->_var['key']): ?>
                <span class="page_now"><?php echo $this->_var['key']; ?></span>
                <?php else: ?>
                <a href="<?php echo $this->_var['item_0_35815200_1477446738']; ?>">[<?php echo $this->_var['key']; ?>]</a>
                <?php endif; ?>
            <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
      ...
      <form action="javascript:;" onsubmit="submitComment(this)" method="post" name="commentForm" id="commentForm">
       <table width="710" border="0" cellspacing="5" cellpadding="0">
        ...
        <tr>
          ...
          <?php endif; ?>
          <input name="" type="submit"  value="" style="border:none; background:url(themes/default/images/commentsBnt.gif); width:75px; height:21px; margin-right:8px; float:right;">
          </td>
        </tr>
      </table>
      </form>
...
//<![CDATA[
<?php $_from = $this->_var['lang']['cmt_lang']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'item_0_35815200_1477446738');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['item_0_35815200_1477446738']):
?>
var <?php echo $this->_var['key']; ?> = "<?php echo $this->_var['item_0_35815200_1477446738']; ?>";
<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
