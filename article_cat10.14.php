...
if (!$smarty->is_cached('article_cat.dwt', $cache_id))
{
    ...
    $smarty->assign('artciles_list',    get_cat_articles($cat_id, $page, $size ,$keywords,$district_id));//print_r(get_cat_articles($cat_id, $page, $size ,$keywords));exit;
...
if($cat_id == 10){
	...
	//$smarty->display('article_cat_bxxy.dwt');
}elseif($cat_id == 29){
